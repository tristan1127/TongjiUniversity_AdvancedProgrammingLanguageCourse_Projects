...
/* 定义光标的形态 */
#define CCT_CURSOR_VISIBLE_FULL				0	//光标显示，全高色块
#define CCT_CURSOR_VISIBLE_HALF				1	//光标显示，半高色块
#define CCT_CURSOR_VISIBLE_NORMAL			2	//光标显示，横线（缺省为此方式）
#define CCT_CURSOR_INVISIBLE				3	//光标不显示
